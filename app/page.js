...
export default function Home() {
  ...
  const text =
    "    Hello, and welcome to my portfolio! I'm an experienced software developer with a passion for crafting innovative solutions through coding. Feel free to explore my projects, where you'll see my expertise in various programming languages and frameworks. Let's connect!";
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      {/* Head component */}
      <Head>
        <title>Ivan Joshua Zapanta</title>
          ...
          <section id="skills" style={{ paddingTop: navbarHeight }}>
            <div>
              ...
              <p className="font-mono text-lg py-2 leading-8 text-gray-800 dark:text-gray-200">
                As a passionate and dedicated software developer, I have honed my expertise in various programming languages
